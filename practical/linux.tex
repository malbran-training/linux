...
Also, do not worry if you do not complte all sections in the time
allocated, a good target to aim for is the end of section 3
\href{advanced_linux.ipynb}{Advanced Linux (loops and Bash scripts)}.
...
\texttt{advanced\_linux} \texttt{awk} \texttt{bash\_scripts}
\texttt{basic} \texttt{files} \texttt{grep}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
ls\PY{+w}{ }/home/manager/course\PYZus{}data/linux/basic/directory\PYZus{}structure.png
\end{Verbatim}
\end{tcolorbox}
...
\item
  Use the \texttt{find} command to find all the gff files in the
